...
const CONTRACT_ADDRESS = "0x65b4744E5eA68A92B04507C82F52b9028fcfb191"; // address of the new contract.
const { abi } = require("./artifacts/contracts/miniDatabase.sol/miniDatabase.json");
